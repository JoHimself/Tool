    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="NotenForm">Noten eintragen</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="Notizen.jsp">Notizen anzeigen</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="NotizenForm">Notiz anlegen</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">Ein Projekt von Sergej Bielke und Jonas Hilberg
          </div>
