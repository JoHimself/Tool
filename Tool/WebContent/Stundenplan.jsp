...
PreparedStatement ps=(PreparedStatement)con.prepareStatement("SELECT tag,stunde,fach, dozent,raum from stundenplan");
ResultSet rs=ps.executeQuery();
while(rs.next()){
	String tag =rs.getString("tag");
	String stunde=rs.getString("stunde");
    ...
    <TABLE BORDER="1" cellpadding="5">
        <TR>
            <TH width="100">Tag</TH>
            <TH width="100">Stunde</TH>
            <TH width="150">Fach</TH>
            <TH width="100">Dozent</TH>
